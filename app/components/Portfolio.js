        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
              Interactive <span className="text-blue-500">Tutorials</span>
            </h3>
          </motion.div>
          ...
          <AnimatePresence mode="popLayout">
            {filteredItems.map((item) => (
              ...
              >
                ...
                <div className="p-8">
                  <span className="text-[10px] font-black uppercase tracking-widest text-blue-500 mb-3 block">
                    {item.category}
                  </span>
                  <h4 className="text-xl font-bold text-gray-900 mb-3 leading-tight group-hover:text-blue-500 transition-colors">
                    {item.title}
                  </h4>
            ...
            {filter === "all" && (
              <motion.a
                ...
                href="https://www.youtube.com/@iammoazzamsultan"
                target="_blank"
                className="group flex flex-col items-center justify-center p-8 bg-gray-50 border-2 border-dashed border-gray-200 rounded-[2rem] hover:border-blue-300 hover:bg-blue-50/20 transition-all duration-300"
              >
        ...
        <AnimatePresence>
          {selectedItem && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-[9999] bg-gray-900/95 backdrop-blur-xl flex items-center justify-center p-0 md:p-8"
                ...
                <div className="w-full lg:w-[35%] p-8 md:p-12 overflow-y-auto flex flex-col bg-white">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-6">
                       <span className="px-3 py-1 bg-blue-50 text-blue-500 text-[10px] font-black uppercase tracking-widest rounded-lg">
                  ...
                  <div className="mt-auto pt-8 border-t border-gray-200">
                    <a
                      ...
                      target="_blank"
                      className="flex items-center justify-center gap-3 w-full py-5 bg-gray-900 text-white rounded-2xl font-bold hover:bg-blue-500 transition-all shadow-xl group"
                    >
                      Watch on YouTube 
